                ...
                <ActionsLayout.Section>
                    <details open className=" pb-5">
                        ...
                        <div className="flex justify-between pt-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <span className="bg-red-500 text-white rounded-full px-2 pb-1">{`Awaiting Assessment`}</span>
                            </div>
                        </div>
                    </details>
                    ...
                    <details open className=" border-t-2 pb-5">
                        ...
                        <div className="grid py-4 gap-4">
                            <div className="bg-white border-teal-700 border-2 border-l-8 p-3">
                                <h2 className="font-bold mb-2">Impact Guidance</h2>
                            ...
                            <div className="bg-white border-teal-700 border-2 border-l-8 p-3">
                                <h2 className="font-bold mb-2">Probablity Guidance</h2>
                                ...
                                <table className="bg-white w-full table-auto border mt-3">
                                    ...
                                    <tbody>
                                        {risk.RiskControl.length > 0 && risk.RiskControl.map((riskControl) => {
                                            return (
                                                <Link href={`/controls/${riskControl.control_id}`}>
